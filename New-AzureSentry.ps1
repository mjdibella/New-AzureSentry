param(
	...
	[Parameter(Mandatory=$false,Position=6)][string]$vhdUri = "https://mobileironsentry.blob.core.windows.net/mobileironsentrycontainer/sentry-mobileiron-9.15.0-15.vhd",
	[Parameter(Mandatory=$false,Position=7)][string]$deploymentTemplateUri = "https://mobileironsentry.blob.core.windows.net/mobileironsentrycontainer/SentryAzureDeploy-9.15.0-15.json",
	[Parameter(Mandatory=$false,Position=8)][string]$deploymentParametersUri = "https://mobileironsentry.blob.core.windows.net/mobileironsentrycontainer/SentryAzureDeploy.parameters-9.15.0-15.json",
